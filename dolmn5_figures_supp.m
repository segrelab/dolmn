...
%% Supp Figure 1: (Nt,Ni) landscapes for 3-strain subnetworks
...
% S1a: Biomass Flux for 3-Strain Subnetworks
n = 1;
...
title(ax,'Supp Figure 1a', 'FontSize',titleSize)
print('DOLMN_Plots_Supp/SuppFigure_1a','-dpdf','-bestfit','-r300','-painters',['-f' int2str(fig.Number)])

% S1b: Difference in Biomass Flux for 1- and 3-Strain Subnetworks
n = 2;
if ishandle(n); clf(findobj('Type','Figure', 'Number',n)); end
...
xlabel(ax,'T_{TR}', 'FontSize',xyLabelSize)
ylabel(ax,'T_{IN}', 'FontSize',xyLabelSize)
title(ax,'Supp Figure 1b', 'FontSize',titleSize)
print('DOLMN_Plots_Supp/SuppFigure_1b','-dpdf','-bestfit','-r300','-painters',['-f' int2str(fig.Number)])

% S1c: Difference in Biomass Flux for 2- and 3-Strain Subnetworks
n = 3;
if ishandle(n); clf(findobj('Type','Figure', 'Number',n)); end
...
xlabel(ax,'T_{TR}', 'FontSize',xyLabelSize)
ylabel(ax,'T_{IN}', 'FontSize',xyLabelSize)
title(ax,'Supp Figure 1c', 'FontSize',titleSize)
print('DOLMN_Plots_Supp/SuppFigure_1c','-dpdf','-bestfit','-r300','-painters',['-f' int2str(fig.Number)])

% S1d: Jaccard Distance for 3-Strain Subnetworks, Strains A & B
n = 4;
if ishandle(n); clf(findobj('Type','Figure', 'Number',n)); end
...
xlabel(ax,'T_{TR}', 'FontSize',xyLabelSize)
ylabel(ax,'T_{IN}', 'FontSize',xyLabelSize)
title(ax,'Supp Figure 1d', 'FontSize',titleSize)
print('DOLMN_Plots_Supp/SuppFigure_1d','-dpdf','-bestfit','-r300','-painters',['-f' int2str(fig.Number)])

% S1e: Jaccard Distance for 3-Strain Subnetworks, Strains A & C
n = 5;
if ishandle(n); clf(findobj('Type','Figure', 'Number',n)); end
fig = figure(n); fig.Name = 'S1e'; ax = axes(fig); clear h*
patch(ax,[0,8.5,8.5,0],[0,0,285,285],[1,1,1].*0.75, 'FaceAlpha',0.75, 'EdgeColor','none'); hold(ax,'on'); 
...
xlabel(ax,'T_{TR}', 'FontSize',xyLabelSize)
ylabel(ax,'T_{IN}', 'FontSize',xyLabelSize)
title(ax,'Supp Figure 1e', 'FontSize',titleSize)
print('DOLMN_Plots_Supp/SuppFigure_1e','-dpdf','-bestfit','-r300','-painters',['-f' int2str(fig.Number)])

% S1f: Jaccard Distance for 3-Strain Subnetworks, Strains B & C
n = 6;
if ishandle(n); clf(findobj('Type','Figure', 'Number',n)); end
fig = figure(n); fig.Name = 'S1f'; ax = axes(fig); clear h*
patch(ax,[0,8.5,8.5,0],[0,0,285,285],[1,1,1].*0.75, 'FaceAlpha',0.75, 'EdgeColor','none'); hold(ax,'on'); 
...
xlabel(ax,'T_{TR}', 'FontSize',xyLabelSize)
ylabel(ax,'T_{IN}', 'FontSize',xyLabelSize)
title(ax,'Supp Figure 1f', 'FontSize',titleSize)
print('DOLMN_Plots_Supp/SuppFigure_1f','-dpdf','-bestfit','-r300','-painters',['-f' int2str(fig.Number)])

% S1g: Jaccard Distance for 3-Strain Subnetworks, Average
n = 7;
if ishandle(n); clf(findobj('Type','Figure', 'Number',n)); end
fig = figure(n); fig.Name = 'S1g'; ax = axes(fig); clear h*
patch(ax,[0,8.5,8.5,0],[0,0,285,285],[1,1,1].*0.75, 'FaceAlpha',0.75, 'EdgeColor','none'); hold(ax,'on'); 
...
xlabel(ax,'T_{TR}', 'FontSize',xyLabelSize)
ylabel(ax,'T_{IN}', 'FontSize',xyLabelSize)
title(ax,'Supp Figure 1g', 'FontSize',titleSize)
print('DOLMN_Plots_Supp/SuppFigure_1g','-dpdf','-bestfit','-r300','-painters',['-f' int2str(fig.Number)])

% S1h: Number of Exchanged Metabolites for 3-Strain Subnetworks
n = 8;
if ishandle(n); clf(findobj('Type','Figure', 'Number',n)); end
fig = figure(n); fig.Name = 'S1h'; ax = axes(fig); clear h*
patch(ax,[0,8.5,8.5,0],[0,0,285,285],[1,1,1].*0.75, 'FaceAlpha',0.75, 'EdgeColor','none'); hold(ax,'on'); 
...
xlabel(ax,'T_{TR}', 'FontSize',xyLabelSize)
ylabel(ax,'T_{IN}', 'FontSize',xyLabelSize)
title(ax,'Supp Figure 1h', 'FontSize',titleSize)
print('DOLMN_Plots_Supp/SuppFigure_1h','-dpdf','-bestfit','-r300','-painters',['-f' int2str(fig.Number)])

% Clear Variables
clear(vars{:})
clear cmap* vars*

%% Supp Figure 2: (Nt,Ni) landscapes for Core 2-strain subnetworks
...
xlabel(ax,'T_{TR}', 'FontSize',xyLabelSize)
ylabel(ax,'T_{IN}', 'FontSize',xyLabelSize)
title(ax,'Supp Figure 2a', 'FontSize',titleSize)
print('DOLMN_Plots_Supp/SuppFigure_2a','-dpdf','-bestfit','-r300','-painters',['-f' int2str(fig.Number)])
...
xlabel(ax,'T_{TR}', 'FontSize',xyLabelSize)
ylabel(ax,'T_{IN}', 'FontSize',xyLabelSize)
title(ax,'Supp Figure 2b', 'FontSize',titleSize)
print('DOLMN_Plots_Supp/SuppFigure_2b','-dpdf','-bestfit','-r300','-painters',['-f' int2str(fig.Number)])
...
xlabel(ax,'T_{TR}', 'FontSize',xyLabelSize)
ylabel(ax,'T_{IN}', 'FontSize',xyLabelSize)
title(ax,'Supp Figure 2c', 'FontSize',titleSize)
print('DOLMN_Plots_Supp/SuppFigure_2c','-dpdf','-bestfit','-r300','-painters',['-f' int2str(fig.Number)])
...
xlabel(ax,'T_{TR}', 'FontSize',xyLabelSize)
ylabel(ax,'T_{IN}', 'FontSize',xyLabelSize)
title(ax,'Supp Figure 2d', 'FontSize',titleSize)
print('DOLMN_Plots_Supp/SuppFigure_2d','-dpdf','-bestfit','-r300','-painters',['-f' int2str(fig.Number)])

% Clear Variables
clear(vars{:})
clear cmap* vars*

%% Supp Figure 3: Number of Metabolites vs Jaccard Distance
...
% S3a: Number of Exchanged Metabolites vs Jaccard Distance for 2-Strain Subnetworks
n = 13;
if ishandle(n); clf(findobj('Type','Figure', 'Number',n)); end
...
title(ax,'Supp Figure 3a', 'FontSize',titleSize)
% R^2
...
print('DOLMN_Plots_Supp/SuppFigure_3a','-dpdf','-bestfit','-r300','-painters',['-f' int2str(fig.Number)])

% S3b: Number of Exchanged Metabolites vs Jaccard Distance for 3-Strain Subnetworks
n = 14;
if ishandle(n); clf(findobj('Type','Figure', 'Number',n)); end
...
xlabel(ax,'Jaccard Distance', 'FontSize',xyLabelSize)
ylabel(ax,'Number of Exchanged Metabolites', 'FontSize',xyLabelSize)
title(ax,'Supp Figure 3b', 'FontSize',titleSize)
% R^2
...
set(ah, 'Parent',ax, 'Position',[0, nanmax([numExchMets_2m(:); numExchMets_3m(:)])-3, ah.Position(3:4)])
print('DOLMN_Plots_Supp/SuppFigure_3b','-dpdf','-bestfit','-r300','-painters',['-f' int2str(fig.Number)])

% Clear Variables
clear(vars{:})
clear cmap* vars* rho* spear*

%% Supp Figure 4: Predicting Metabolite Exchange
...
% S4a: Percentage Exchanged vs Percentage Secreted Mets
n = 15;
if ishandle(n); clf(findobj('Type','Figure', 'Number',n)); end
...
title(ax,'Supp Figure 4a', 'FontSize',titleSize)
print('DOLMN_Plots_Supp/SuppFigure_4a','-dpdf','-bestfit','-r300','-painters',['-f' int2str(fig.Number)])
clear spear*

% Spearman Coeff
rho23 = corr(N2,N3, 'type','Pearson');
spear23 = corr(N2,N3, 'type','Spearman');
% S4b: Percentage Exchanged Mets in 3 vs 2
n = 16;
if ishandle(n); clf(findobj('Type','Figure', 'Number',n)); end
...
title(ax,'Supp Figure 4b', 'FontSize',titleSize)
% R^2
...
print('DOLMN_Plots_Supp/SuppFigure_4b','-dpdf','-bestfit','-r300','-painters',['-f' int2str(fig.Number)])
clear rho* spear*

% Spearman Coeff
spear2 = corr(cost,N2, 'type','Spearman');
spear3 = corr(cost,N3, 'type','Spearman');
% S4c: Number of Exchanged Mets vs Cost to Produce
n = 17;
if ishandle(n); clf(findobj('Type','Figure', 'Number',n)); end
...
ylabel(ax,'Exchanged in 2- & 3-Strain Simulations (%)', 'FontSize',xyLabelSize)
title(ax,'Supp Figure 4c', 'FontSize',titleSize)
print('DOLMN_Plots_Supp/SuppFigure_4c','-dpdf','-bestfit','-r300','-painters',['-f' int2str(fig.Number)])
clear spear*

% Spearman Coeff
spear2 = corr(numRxns,N2, 'type','Spearman');
spear3 = corr(numRxns,N3, 'type','Spearman');
% S4d: Number of Exchanged Mets vs Number of Reactions
n = 18;
if ishandle(n); clf(findobj('Type','Figure', 'Number',n)); end
...
ylabel(ax,'Exchanged in 2- & 3-Strain Simulations (%)', 'FontSize',xyLabelSize)
title(ax,'Supp Figure 4d', 'FontSize',titleSize)
print('DOLMN_Plots_Supp/SuppFigure_4d','-dpdf','-bestfit','-r300','-painters',['-f' int2str(fig.Number)])
clear spear*
...
% S4e: Number of Exchanged Mets vs Biomass Coefficient
n = 19;
if ishandle(n); clf(findobj('Type','Figure', 'Number',n)); end
...
ylabel(ax,'Exchanged in 2- & 3-Strain Simulations (%)', 'FontSize',xyLabelSize)
title(ax,'Supp Figure 4e', 'FontSize',titleSize)
print('DOLMN_Plots_Supp/SuppFigure_4e','-dpdf','-bestfit','-r300','-painters',['-f' int2str(fig.Number)])
clear rho* spear*
...
xlabel(ax,'T_{TR}', 'FontSize',xyLabelSize)
ylabel(ax,'T_{IN}', 'FontSize',xyLabelSize)
title(ax,'Supp Figure 5a', 'FontSize',titleSize)
print('DOLMN_Plots_Supp/SuppFigure_5a','-dpdf','-bestfit','-r300','-painters',['-f' int2str(fig.Number)])
...
xlabel(ax,'T_{TR}', 'FontSize',xyLabelSize)
ylabel(ax,'T_{IN}', 'FontSize',xyLabelSize)
title(ax,'Supp Figure 5b', 'FontSize',titleSize)
print('DOLMN_Plots_Supp/SuppFigure_5b','-dpdf','-bestfit','-r300','-painters',['-f' int2str(fig.Number)])
...
xlabel(ax,'T_{TR}', 'FontSize',xyLabelSize)
ylabel(ax,'T_{IN}', 'FontSize',xyLabelSize)
title(ax,'Supp Figure 5c', 'FontSize',titleSize)
print('DOLMN_Plots_Supp/SuppFigure_5c','-dpdf','-bestfit','-r300','-painters',['-f' int2str(fig.Number)])

% S5d: N3
n = 23;
if ishandle(n); clf(findobj('Type','Figure', 'Number',n)); end
fig = figure(n); fig.Name = 'S5d'; ax = axes(fig); clear h*
patch(ax,[0,8.5,8.5,0],[0,0,285,285],[1,1,1].*0.75, 'FaceAlpha',0.75, 'EdgeColor','none'); hold(ax,'on');
...
xlabel(ax,'T_{TR}', 'FontSize',xyLabelSize)
ylabel(ax,'T_{IN}', 'FontSize',xyLabelSize)
title(ax,'Supp Figure 5d', 'FontSize',titleSize)
print('DOLMN_Plots_Supp/SuppFigure_5d','-dpdf','-bestfit','-r300','-painters',['-f' int2str(fig.Number)])

% S5e: O2
n = 24;
if ishandle(n); clf(findobj('Type','Figure', 'Number',n)); end
fig = figure(n); fig.Name = 'S5e'; ax = axes(fig); clear h*
patch(ax,[0,8.5,8.5,0],[0,0,285,285],[1,1,1].*0.75, 'FaceAlpha',0.75, 'EdgeColor','none'); hold(ax,'on');
...
xlabel(ax,'T_{TR}', 'FontSize',xyLabelSize)
ylabel(ax,'T_{IN}', 'FontSize',xyLabelSize)
title(ax,'Supp Figure 5e', 'FontSize',titleSize)
print('DOLMN_Plots_Supp/SuppFigure_5e','-dpdf','-bestfit','-r300','-painters',['-f' int2str(fig.Number)])

% S5f: O3
n = 25;
if ishandle(n); clf(findobj('Type','Figure', 'Number',n)); end
fig = figure(n); fig.Name = 'S5f'; ax = axes(fig); clear h*
patch(ax,[0,8.5,8.5,0],[0,0,285,285],[1,1,1].*0.75, 'FaceAlpha',0.75, 'EdgeColor','none'); hold(ax,'on');
...
xlabel(ax,'T_{TR}', 'FontSize',xyLabelSize)
ylabel(ax,'T_{IN}', 'FontSize',xyLabelSize)
title(ax,'Supp Figure 5f', 'FontSize',titleSize)
print('DOLMN_Plots_Supp/SuppFigure_5f','-dpdf','-bestfit','-r300','-painters',['-f' int2str(fig.Number)])
...
%% Supp Figure 6: Distance between 2-Strain Subnetworks
...
title(ax,'Supp Figure 6a', 'FontSize',titleSize)
print('DOLMN_Plots_Supp/SuppFigure_6a','-dpdf','-bestfit','-r300','-painters',['-f' int2str(fig.Number)])

% S6b: Euclidean Distance
n = 27;
if ishandle(n); clf(findobj('Type','Figure', 'Number',n)); end
...
title(ax,'Supp Figure 6b', 'FontSize',titleSize)
print('DOLMN_Plots_Supp/SuppFigure_6b','-dpdf','-bestfit','-r300','-painters',['-f' int2str(fig.Number)])
...
n = 28;
if ishandle(n); clf(findobj('Type','Figure', 'Number',n)); end
fig = figure(n); fig.Name = 'S7'; clear h*
...
[~,ht]=suplabel('Supp Figure 7','t'); ht.FontSize = titleSize; ht.Position = [0.5,1.006,0.5];
print('DOLMN_Plots_Supp/SuppFigure_7','-dpdf','-bestfit','-r300','-painters',['-f' int2str(fig.Number)])

% Clear Variables
clear(vars{:})
clear cmap* vars*

%% Supp Figure 8: Phi Coefficient
...
n = 29;
if ishandle(n); clf(findobj('Type','Figure', 'Number',n)); end
fig = figure(n); fig.Name = 'S8'; ax = axes(fig); clear h*
imagesc(ax,phi);
...
title(ax,'Supp Figure 8', 'FontSize',titleSize)
print('DOLMN_Plots_Supp/SuppFigure_8','-dpdf','-bestfit','-r300','-painters',['-f' int2str(fig.Number)])
...
%% Supp Figure 9-10: Metabolite secretion/exchange profiles
...
[~,ht]=suplabel('Supp Figure 9','t'); ht.FontSize = titleSize; ht.Position = [0.5,1.006,0.5];
print('DOLMN_Plots_Supp/SuppFigure_9','-dpdf','-bestfit','-r300','-painters',['-f' int2str(fig.Number)])

% S10: 2-Strain Subnetworks
n = 31;
if ishandle(n); clf(findobj('Type','Figure', 'Number',n)); end
...
[~,hx]=suplabel('T_{TR}','x'); hx.FontSize = xyLabelSize; hx.Position = [0.5,0,0];
[~,hy]=suplabel('T_{IN}','y'); hy.FontSize = xyLabelSize; hy.Position = [0,0.5,0];
[~,ht]=suplabel('Supp Figure 10','t'); ht.FontSize = titleSize; ht.Position = [0.5,1.006,0.5];
print('DOLMN_Plots_Supp/SuppFigure_10','-dpdf','-bestfit','-r300','-painters',['-f' int2str(fig.Number)])

% S11: 3-Strain Subnetworks
n = 32;
if ishandle(n); clf(findobj('Type','Figure', 'Number',n)); end
...
[~,hx]=suplabel('T_{TR}','x'); hx.FontSize = xyLabelSize; hx.Position = [0.5,0,0];
[~,hy]=suplabel('T_{IN}','y'); hy.FontSize = xyLabelSize; hy.Position = [0,0.5,0];
[~,ht]=suplabel('Supp Figure 11','t'); ht.FontSize = titleSize; ht.Position = [0.5,1.006,0.5];
print('DOLMN_Plots_Supp/SuppFigure_11','-dpdf','-bestfit','-r300','-painters',['-f' int2str(fig.Number)])
...
%% Supp Figure 12-13: Metabolic Differentiation
...
[~,hx]=suplabel('T_{TR}','x'); hx.FontSize = xyLabelSize; hx.Position = [0.5,0,0];
[~,hy]=suplabel('T_{IN}','y'); hy.FontSize = xyLabelSize; hy.Position = [0,0.5,0];
[~,ht]=suplabel('Supp Figure 12','t'); ht.FontSize = titleSize; ht.Position = [0.5,1.006,0.5];
print('DOLMN_Plots_Supp/SuppFigure_12','-dpdf','-bestfit','-r300','-painters',['-f' int2str(fig.Number)])

% S13: Euclidean Distance
n = 34;
if ishandle(n); clf(findobj('Type','Figure', 'Number',n)); end
...
[~,hx]=suplabel('T_{TR}','x'); hx.FontSize = xyLabelSize; hx.Position = [0.5,0,0];
[~,hy]=suplabel('T_{IN}','y'); hy.FontSize = xyLabelSize; hy.Position = [0,0.5,0];
[~,ht]=suplabel('Supp Figure 13','t'); ht.FontSize = titleSize; ht.Position = [0.5,1.006,0.5];
print('DOLMN_Plots_Supp/SuppFigure_13','-dpdf','-bestfit','-r300','-painters',['-f' int2str(fig.Number)])
...
%% Supp Figure 14: Point-Biserial Correlation Between Jaccard Distance and Exchanged Metabolite Landscape
...
% S14a: Point-Biserial Correlation (Euclidean)
n = 35;
if ishandle(n); clf(findobj('Type','Figure', 'Number',n)); end
...
title(ax,'Supp Figure 14a', 'FontSize',titleSize)
print('DOLMN_Plots_Supp/SuppFigure_14a','-dpdf','-bestfit','-r300','-painters',['-f' int2str(fig.Number)])

% S14a: Point-Biserial Correlation (Jaccard)
n = 36;
if ishandle(n); clf(findobj('Type','Figure', 'Number',n)); end
...
xlabel(ax,'Metabolites', 'FontSize',xyLabelSize)
ylabel(ax,'Pathways', 'FontSize',xyLabelSize)
title(ax,'Supp Figure 14b', 'FontSize',titleSize)
print('DOLMN_Plots_Supp/SuppFigure_14b','-dpdf','-bestfit','-r300','-painters',['-f' int2str(fig.Number)])
...
%% Supp Figure 15: Minimum number of intracellular reactions needed for growth
...
n = 37;
if ishandle(n); clf(findobj('Type','Figure', 'Number',n)); end
fig = figure(n); fig.Name = 'S15a'; ax = axes(fig); clear h*
...
ylabel(ax,'T_{IN}', 'FontSize',xyLabelSize)
title(ax,'Supp Figure 15a', 'FontSize',titleSize)
print('DOLMN_Plots_Supp/SuppFigure_15a','-dpdf','-bestfit','-r300','-painters',['-f' int2str(fig.Number)])

% S15b: Same Ni
n = 38;
if ishandle(n); clf(findobj('Type','Figure', 'Number',n)); end
fig = figure(n); fig.Name = 'S15b'; ax = axes(fig); clear h*
...
title(ax,'Supp Figure 15b', 'FontSize',titleSize)
print('DOLMN_Plots_Supp/SuppFigure_15b','-dpdf','-bestfit','-r300','-painters',['-f' int2str(fig.Number)])
...
%% Supp Figure 16: What are the 9 transporters kept?
...
n = 39;
if ishandle(n); clf(findobj('Type','Figure', 'Number',n)); end
fig = figure(n); fig.Name = 'S16a'; ax = axes(fig); clear h*
hold(ax,'on');
...
title(ax,'Supp Figure 16', 'FontSize',titleSize)
print('DOLMN_Plots_Supp/SuppFigure_16','-dpdf','-bestfit','-r300','-painters',['-f' int2str(fig.Number)])
